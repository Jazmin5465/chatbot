...
<{plot_description}>
Write this as one paragraph in a way that is exciting to promote the launch of a new book."""
...
book_summary = get_response_from_chatbot(model, messages)
...
"""An atmospheric masterpiece! The author's vivid descriptions make you feel like you're
...
for review in book_reviews:
    ...
    review_prompt = f"""
    Determine the sentiment of this book review as a single word positive or negative:
    <{review}>
    """
    messages = [
        {"role":"system","content":"You are a helpful assistant."},
    ...
    sentiment = get_response_from_chatbot(model, messages)
